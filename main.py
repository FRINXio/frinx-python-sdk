...
from frinx.workflows.dynamic_fork.dynamic_fork_workflows import DynamicForkWFService
...
def register_tasks(conductor_client):
    ...
    logging.info('Register UTIL workers')
    WFInputHandlersService().register(conductor_client)
